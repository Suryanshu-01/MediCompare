...
export const REMOTE_API_URL =
  ...
  "https://medicompare-backend.onrender.com/api";

// Will be set dynamically based on availability
export let API_BASE_URL = LOCAL_API_URL;
...
export const ROUTES = {
  ...
  ADD_SERVICE: "/hospital/services/add",
...
export const SUCCESS_MESSAGES = {
  ...
  HOSPITAL_SUBMITTED: "Hospital registration submitted for verification",
